...
// import Vid from "./Main_Loop_12.mp4";
        ...
        <div className="header-wrapper container">
          ...
          <div className="header-item nav-toggle">
            <span className="nav-list-item">
              <NavLink activeClassName="active-NavLink" to="/register">
                <Icons.Login />
              </NavLink>
            </span>
          ...
          <div
            className={
              Mobile
                ? "header-item nav-wrapper nav-show"
            ...
            <nav className="nav-list-wrapper">
              <>
                <ul className="nav-list-item-wrapper" type="none">
                  <li className="nav-list-item" onClick={Mob}>
                    <NavLink exact activeClassName="active-NavLink" to="/">
                      Home
                    </NavLink>
                  </li>
                  <li className="nav-list-item" onClick={Mob}>
                    <NavLink activeClassName="active-NavLink" to="/services">
                      Services
                    </NavLink>
                  </li>
                  {/* <li className="nav-list-item" onClick={Mob}>
                    <NavLink activeClassName="active-NavLink" to="/articles">
                      Articles
                    </NavLink>
                  </li> */}
                  <li className="nav-list-item" onClick={Mob}>
                  ...
                  <li className="jkl" onClick={Mob}>
                    <FaTimes />
                  </li>
                  <span className="nav-list-item dis60">
                    <NavLink activeClassName="active-NavLink" to="/register">
                      <Icons.Login />
                    </NavLink>
                  </span>
